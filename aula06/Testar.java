...
public class  Testar {
    ...
    public void verificar() {
        ...
        if(c.size() == tamVetor)
            System.out.println("Permite inclusão de elementos duplicados");
        else
            System.out.println("Não permite elementos duplicados");
        
        //Verificar se ordena automaticamente os elementos inseridos na collection
        ...
        for(Object o: c) {
           ...
           if(!validar) 
               System.out.println("Tá ordenado");
           else
               System.out.println("Não tá ordenado");
        ...
        //condicao para saber se ordena, apos o for
        if(verificar)
