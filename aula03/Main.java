...
public class Main {
    public static void main(String[] args) {
          //QUESTAO 03	
	  //Falta fazer mover os pontos de uma figura 	
      Quadrado d1 = new Quadrado();
      Quadrado d2 = new Quadrado();

      //Parte reservada para os testes dos dois quadrados
      ...
      //Parte reservada para os testes dos dois circulos
